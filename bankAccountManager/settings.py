"""
Django settings for bankAccountManager project.
...
SECRET_KEY = 'django-insecure-xo5t$eta1#-icz@i9h#st-q3+l%*(63(_(-506zv%e4(062v3^'
...
STATIC_URL = 'static/'
STATIC_ROOT = 'bankAccountManager/static/'
